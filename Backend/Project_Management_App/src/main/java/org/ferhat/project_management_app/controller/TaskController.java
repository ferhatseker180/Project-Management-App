...
public class TaskController {
    ...
    @PostMapping("/add")
    public ResponseEntity<ResultData<TaskResponse>> addTask(@RequestBody TaskRequest taskRequest) {
        ResultData<TaskResponse> result = taskService.addTask(taskRequest);
