...
export default function SelectedProject({ project, onDelete, onAddTask, onDeleteTask, tasks, onUpdateProject, onCompleteTask }) {
  ...
  // update editedProject state when project prop changes
  useEffect(() => {
    if (project) {
      setEditedProject({
        title: project.title || '',
  ...
  const handleUpdate = () => {
    ...
    const updatedProject = {
      ...project,
      ...editedProject,
      dueDate: new Date(editedProject.dueDate).toISOString()
    };
